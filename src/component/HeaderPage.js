...
const HeaderPage = ({ title ,onPress}) => {
    return (
        <View style={{ flexDirection: "row", backgroundColor: "#021D49",height:windowHeight/10, width:windowWidth,}}>
            ...
            <View style={{ width: windowWidth - 90, alignItems: "center", justifyContent: "center" }}>
                <Text style={{ color: "white", fontSize: 25 ,marginTop:20}}>{title}</Text>
            </View>
        </View>
    )
}
